...
<script src="<%=path %>/scripts/back/index.js"></script>
<script src="<%=path %>/scripts/back/tourtype/tourType2.js"></script>
<script src="<%=path %>/scripts/back/line/line2.js"></script>
