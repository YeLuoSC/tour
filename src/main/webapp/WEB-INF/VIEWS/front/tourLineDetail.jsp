...
<script src="<%=path %>/scripts/front/index/tourLineDetail.js"></script>
...
<body ng-app="myapp" ng-controller="tourLineDetailController">
		...
		<div class="top-nav">
			...
			<ul class="nav1">
				<li><a href="<%=path %>/front/index.do">TOURISM </a></li>
					<li><a href="<%=path %>/front/tourinfo.do" class="active">TOURINFO</a></li>
					<li><a href="<%=path %>/front/attraction.do">ATTRACTIONS</a></li>
					<li>
						<div class="dropdown">
		...
		<div class="container">
			<div class="blog-top">
				<div class="col-md-9 blog-left">
					<div class="blog-main">
						<a class="bg"><c:out value='${tourLinePO.tourLineName}'></c:out></a>
						<p>Price:$<c:out value='${tourLinePO.price}'></c:out>,StartDate:<fmt:formatDate value="${tourLinePO.startDate}" pattern="yyyy/MM/dd" /> <a href="#">${fn:length(comments)} comments</a></p>
					</div>								
					<div class="blog-main-one">
						<div class="blog-one blog-sng">
							<img src="${tourLinePO.thumbnail}" alt="" />
							<p class="sngl"><c:out value='${tourLinePO.info}' escapeXml="false"></c:out></p>
						</div>	
						<div class="comments cmt">
								<ul>
									<li><span class="bookmark"> </span><a href="#"><c:out value='${tourLinePO.tourTypePO.tourTypeName}'></c:out></a></li>
						...
						<c:if test="${bookInfoPO.replyInfo !=null}">
							<div class="comment-list">
								...
								<div class="cmt-list">
									...
									<div class="cmt-right">
										<p><c:out value='${bookInfoPO.replyInfo}' escapeXml="false"></c:out></p>
									</div>
									<div class="clearfix"></div>
								</div>
							</div>
						...
						<ul class="media-list">
							<li class="media">
								<div class="media-left">
									<img src="<%=path %>/images/front/avatar.png"/>
								</div>
								<div class="media-body">
									<h4 class="media-heading"><c:out value='${bookInfoPO.customerName}'></c:out></h4>
									<p><c:out value='${bookInfoPO.customerInfo}'></c:out></p>
									<c:if test="${bookInfoPO.replyInfo !=null}">
										<div class="media">
											<div class="media-left"><img src="<%=path %>/images/front/avatar.png"/></div>
											<div class="media-body"><h5 class="media-heading">Admin</h5>
					...
					<div class="related">
							...
							<div class="related-bottom">
								<c:forEach var="tourLinePO" items="${otherTourLineList}" varStatus="status">
									<div class="col-md-3 related-left">
										<a href="<%=path %>/front/detailInfo/getTourLineDetailInfo.do?tourLineId=<c:out value='${tourLinePO.tourLineId}'></c:out>">
											<img src="${tourLinePO.thumbnail}"/>
										</a>
										<h4><c:out value='${tourLinePO.tourLineName}'></c:out></h4>
									</div>
								</c:forEach>
								<div class="clearfix"></div>
							</div>
						...
						<div class="content">
					 		...
					 		<div class="contact-form">
								<form>
									...
									<input type="hidden" value="1" ng-init="bookInfo.bookType='1'"/>
									<input type="hidden" ng-init="bookInfo.relationId=<c:out value='${tourLinePO.tourLineId}'></c:out>"/>
				...
				<div class="col-md-3 blog-right">
					...
					<div class="categories">
						...
						<ul>
							<c:forEach var="tourLinePO" items="${otherTourLineList}" varStatus="status">
								<li><a href="<%=path %>/front/detailInfo/getTourLineDetailInfo.do?tourLineId=<c:out value='${tourLinePO.tourLineId}'></c:out>"><c:out value='${tourLinePO.tourLineName}'></c:out></a></li>
							</c:forEach>
						</ul>
					</div>
					<%--<div class="categories">
